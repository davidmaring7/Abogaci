		...
		class gdlr_core_sidebar_generator{
			...
			function __construct( $sidebar_args = array() ){
				...
				$this->footer_widgets = array(
					array( 'name'=>esc_html__('Footer 1', 'attorna'), 'id'=>'footer-1', 'description'=>esc_html__('Footer Column 1', 'attorna') ), 
					array( 'name'=>esc_html__('Footer 2', 'attorna'), 'id'=>'footer-2', 'description'=>esc_html__('Footer Column 2', 'attorna') ), 
					array( 'name'=>esc_html__('Footer 3', 'attorna'), 'id'=>'footer-3', 'description'=>esc_html__('Footer Column 3', 'attorna') ), 
					array( 'name'=>esc_html__('Footer 4', 'attorna'), 'id'=>'footer-4', 'description'=>esc_html__('Footer Column 4', 'attorna') )
				);
			...
			function register_sidebar_widget(){
				...
				$sidebar_args['name'] = esc_html__('Single Post Sidebar', 'attorna');
				$sidebar_args['id'] = 'gdlr-core-sidebar-preset';
				$sidebar_args['description'] = esc_html__('Another Custom widget area', 'attorna');
				...
				foreach ( $this->sidebars as $sidebar ){
					...
					$sidebar_args['description'] = esc_html__('Custom widget area', 'attorna');
