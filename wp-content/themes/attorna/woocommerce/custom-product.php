 ...
 */
	...
	$sidebar_type = attorna_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = attorna_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = attorna_get_option('general', 'woocommerce-archive-sidebar-right');		
