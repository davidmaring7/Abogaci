 ...
 */
	...
	if( is_tax('portfolio_category') || is_tax('portfolio_tag') && class_exists('gdlr_core_pb_element_portfolio') ){
		...
		$sidebar_type = attorna_get_option('general', 'archive-portfolio-sidebar', 'none');
		$sidebar_left = attorna_get_option('general', 'archive-portfolio-sidebar-left');
		$sidebar_right = attorna_get_option('general', 'archive-portfolio-sidebar-right');		
	}else{
		$post_type = 'post';

		$sidebar_type = attorna_get_option('general', 'archive-blog-sidebar', 'none');
		$sidebar_left = attorna_get_option('general', 'archive-blog-sidebar-left');
		$sidebar_right = attorna_get_option('general', 'archive-blog-sidebar-right');
	}
