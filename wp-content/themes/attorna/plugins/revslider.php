<?php
	...
	add_filter('revslider_getUsedFonts', 'attorna_revslider_getUsedFonts');
	if( !function_exists('attorna_revslider_getUsedFonts') ){
		function attorna_revslider_getUsedFonts( $used_font ){
