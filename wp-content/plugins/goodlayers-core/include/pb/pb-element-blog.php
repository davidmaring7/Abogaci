						...
						'options' => array(
							...
							'blog-column-style' => array(
								...
								'options' => array(
									...
									'style-2' => esc_html__('Style 2', 'goodlayers-core'),
									'style-3' => esc_html__('Style 3', 'goodlayers-core'),
									'style-4' => esc_html__('Style 4', 'goodlayers-core'),
									'style-4-left-button' => esc_html__('Style 4 (Left Button)', 'goodlayers-core'),
								),
							...
							'blog-image-style' => array(
								...
								'options' => array(
									...
									'style-2' => esc_html__('Style 2', 'goodlayers-core'),
									'style-3' => esc_html__('Style 3', 'goodlayers-core'),
									'style-4' => esc_html__('Style 4 ( Slide Excerpt )', 'goodlayers-core'),
								),
