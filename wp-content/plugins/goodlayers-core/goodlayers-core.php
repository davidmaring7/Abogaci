	...
	*/
	...
	if( !function_exists('gdlr_core_front_script') ){
		function gdlr_core_front_script( $admin = false ){
			...
			wp_enqueue_style('gdlr-core-plugin', GDLR_CORE_URL . '/plugins/style.css');
			wp_enqueue_script('gdlr-core-plugin', GDLR_CORE_URL . '/plugins/script.js', array('jquery'), false, true);
