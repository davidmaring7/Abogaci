				...
				return array(					
					...
					'settings' => array(
						...
						'options' => array(
							...
							'hover-content' => array(
								'title' => esc_html__('Hover Content', 'goodlayers-core-personnel'),
								'type' => 'combobox',
								'options' => array(
									'' => esc_html__('None', 'goodlayers-core-personnel'),
							...
							'enable-hover-title' => array(
								'title' => esc_html__('Enable Hover Title', 'goodlayeres-core-personnel'),
								'type' => 'checkbox',
								'default' => 'disable',
								'condition' => array( 'personnel-style' => array('grid','grid-no-space', 'grid-with-background', 'medium') )
							),
							...
							'social-hover-color' => array(
								...
								'type' => 'colorpicker',
								'condition' => array( 'enable-hover-social' => 'round-border' )
							),
							'enable-hover-excerpt' => array(
								'title' => esc_html__('Enable Hover Excerpt', 'goodlayeres-core-personnel'),
								'type' => 'checkbox',
								'default' => 'disable',
								'condition' => array( 'personnel-style' => array('grid','grid-no-space', 'grid-with-background', 'medium') )
							),
		...
		jQuery('#gdlr-core-preview-personnel-<?php echo esc_attr($id); ?>').parent().gdlr_core_flexslider();
			...
			static function personnel_list_content( $query, $settings ){ 
				...
				while( $query->have_posts() ){ $query->the_post();
					...
					$ret .= '<div class="gdlr-core-item-list gdlr-core-personnel-list-column ' . esc_attr($column_class) . '" ' . gdlr_core_esc_style(array(
